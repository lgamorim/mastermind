...
- PascalCase for types, methods, properties, constants, and public members; camelCase for locals and parameters; `camelCase` for private instance fields (`private static readonly` values are constant-like and stay PascalCase); `I` prefix for interfaces; `Async` suffix for async methods.
